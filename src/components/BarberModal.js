...
export default ({show, setShow, user, service}) => {
    ...
    const [selecteHour, setSelectedHour] = useState(null);
                ...
                <ModalItem>
                  <TimeList horizontal={true} showsHorizontalScrollIndicator={false}>
                     {listHours.map((item, key)=>(
                        ...
                        style={{
                            backgroundColor: item === selecteHour ? '#4EADBE' : '#FFFFFF'
                        }}
                        >
                        <TimeItemText
                            style={{
                                color: item === selecteHour ? '#FFFFFF' : '#000000',
                                fontWeight: item === selecteHour ?  'bold' : 'normal'
                            }}
                        >{item}</TimeItemText>
                        </TimeItem>
                     ))}
